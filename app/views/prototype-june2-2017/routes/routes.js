module.exports = function(app){
    ...
    app.post('*/prototype-june2-2017/representation', function(req, res){
    ...
    app.post('*/prototype-june2-2017/claim-interest', function (req, res) {
        if (!req.body.interestRate) {
            res.render('prototype-june2-2017/claim-interest')
        }
    ...
    app.post('*/prototype-june2-2017/choose-how-to-pay', function (req, res) {
        if (!req.body.paymentType) {
            res.render('prototype-june2-2017/choose-how-to-pay')
        }
