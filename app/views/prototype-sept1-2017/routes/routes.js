module.exports = function(app){
    ...
    app.post('*/prototype-sept1-2017/representation', function(req, res){
    ...
    app.get('*/prototype-sept1-2017/defendants-service-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-sept1-2017/defendants-service-address', { defendants: defendants })
    });

    app.get('*/prototype-sept1-2017/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-sept1-2017/defendant-type', { defendants: defendants })
    });

    app.post('*/prototype-sept1-2017/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.get('*/prototype-sept1-2017/defendant-details', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-sept1-2017/defendant-details', { defendants: defendants })
    });

    app.post('*/prototype-sept1-2017/defendant-represented', function(req, res){
        if (req.body.defendantRepresented === undefined) {
            res.render('prototype-sept1-2017/defendant-represented')
    ...
    app.get('*/prototype-sept1-2017/defendant-reps-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-sept1-2017/defendant-reps-address', { defendants: defendants })
    });

    app.post('*/prototype-sept1-2017/defendant-reps-address', function(req, res){
    ...
    app.post('*/prototype-sept1-2017/defendants-service-address', function(req, res){
        res.redirect('defendant-add')
    });

    app.get('*/prototype-sept1-2017/defendant-add', function(req, res){
        var defendants = req.session.defendants || [];
        ...
        res.render('prototype-sept1-2017/defendant-add', { defendants: defendants })
    });

    app.post('*/prototype-sept1-2017/defendant-add', function(req, res){
    ...
    app.post('*/prototype-sept1-2017/jurisdiction', function(req, res){

        if (!req.body.serviceLocation) {
            res.render('prototype-sept1-2017/jurisdiction')
        }
    ...
    app.post('*/prototype-sept1-2017/type-of-claim', function(req, res){
        if (!req.body.typeOfClaim) {
            res.render('prototype-sept1-2017/type-of-claim')
        }
    ...
    app.post('*/prototype-sept1-2017/spec-claim-amount-type', function(req, res){
        if (!req.body.interestTotal) {
            res.render('prototype-sept1-2017/spec-claim-amount-type')
        }
    ...
    app.post('*/prototype-sept1-2017/fixed-claim-amount-total', function(req, res){
    ...
    app.post('*/prototype-sept1-2017/choose-how-to-pay', function (req, res) {
        if (!req.body.paymentType) {
            res.render('prototype-sept1-2017/choose-how-to-pay')
        }
    ...
    app.post('*/prototype-sept1-2017/fixed-claim-amount', function (req, res) {
    ...
    app.post('*/prototype-sept1-2017/personal-injury', function (req, res) {
        res.redirect('housing-disrepair')
    });

    app.post('*/prototype-sept1-2017/housing-disrepair', function (req, res) {
        res.redirect('claim-details')
    });

    app.post('*/prototype-sept1-2017/claim-details', function (req, res) {
    ...
    app.post('*/prototype-sept1-2017/claim-amount', function (req, res) {
        res.redirect('claim-total')
    });

    app.get('*/prototype-sept1-2017/claim-total', function (req, res) {
        var value = 0;
        ...
        if (req.session.data.typeOfClaim === 'specified') {
            ...
            res.render('prototype-sept1-2017/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount), claimType: req.session.data.typeOfClaim, total: formatter.format(value), fee: formatter.format(fee)})
        }
        else {
            res.render('prototype-sept1-2017/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount) })
        }
    });

    app.post('*/prototype-sept1-2017/claim-total', function (req, res) {
        res.redirect('claim-details-summary')
    })

    app.get('*/prototype-sept1-2017/claim-details-summary', function (req, res) {
        var defendants = req.session.defendants || [];
        var formatter = new Intl.NumberFormat('en-GB', {
            style: 'currency',
            currency: 'GBP',
        ...
        res.render('prototype-sept1-2017/claim-details-summary', { issueFeeAmount: req.session.data.issueFeeAmount, defendants: defendants, value: formatter.format(req.session.data.value), claimType: req.session.data.typeOfClaim })
    })

    app.get('*/prototype-sept1-2017/claim-submitted', function (req, res) {
        var moment = require('moment');
        ...
        res.render('prototype-sept1-2017/claim-submitted', {today: moment().format('D MMMM YYYY'), claimType: req.session.data.typeOfClaim, issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount), value: formatter.format(req.session.data.value)  })
    })

    app.get('*/prototype-sept1-2017/pay-by-card', function (req, res) {
        res.render('prototype-sept1-2017/pay-by-card')
    })

    app.get('*/prototype-sept1-2017/pay-by-account', function (req, res) {
        res.render('prototype-sept1-2017/pay-by-account')
    })

    app.get('*/prototype-sept1-2017/email', function (req, res) {
        var moment = require('moment');
        var issueDate = moment();
        ...
        res.render('prototype-sept1-2017/email', {issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount)})
    })


    app.get('*/prototype-sept1-2017/logout', function (req, res) {
        req.session.destroy()
        res.redirect('login')
    })
