module.exports = function(app){
    ...
    app.post('*/prototype-dec-2017/representative-address', function(req, res){
        req.session.orgName = req.body['rep_company_name'];

        res.render('prototype-dec-2017/representative-address');
    });
    ...
    app.post('*/prototype-dec-2017/claimant-name', function(req, res){
        var claimants = req.session.claimants || [];
    ...
    app.get('*/prototype-dec-2017/claimant-address', function(req, res){
        var claimants = req.session.claimants || [];

        res.render('prototype-dec-2017/claimant-address', { claimants: claimants })
    });


    app.post('*/prototype-dec-2017/claimant-add', function(req, res){
        ...
        if (req.body.addClaimant === undefined) {
            ...
            res.render('prototype-dec-2017/claimant-add', { claimants: claimants })
    ...
    app.post('*/prototype-dec-2017/representation', function(req, res){
    ...
    app.get('*/prototype-dec-2017/defendants-service-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-dec-2017/defendants-service-address', { defendants: defendants })
    });

    app.get('*/prototype-dec-2017/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-dec-2017/defendant-type', { defendants: defendants })
    });

    app.post('*/prototype-dec-2017/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.get('*/prototype-dec-2017/defendant-details', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-dec-2017/defendant-details', { defendants: defendants })
    });

    app.post('*/prototype-dec-2017/defendant-represented', function(req, res){
        if (req.body.defendantRepresented === undefined) {
            res.render('prototype-dec-2017/defendant-represented')
    ...
    app.get('*/prototype-dec-2017/defendant-reps-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-dec-2017/defendant-reps-address', { defendants: defendants })
    });

    app.post('*/prototype-dec-2017/defendant-reps-address', function(req, res){
    ...
    app.post('*/prototype-dec-2017/defendants-service-address', function(req, res){
    ...
    app.post('*/prototype-dec-2017/defendants-service-address-other', function(req, res){
    ...
    app.get('*/prototype-dec-2017/defendant-add', function(req, res){
        ...
        res.render('prototype-dec-2017/defendant-add', { defendants: defendants })
    });


    app.post('*/prototype-dec-2017/defendant-add', function(req, res){
    ...
    app.post('*/prototype-dec-2017/jurisdiction-statements', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-dec-2017/jurisdiction-statements-2', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-dec-2017/type-of-claim', function(req, res){
        if (!req.body.typeOfClaim) {
            res.render('prototype-dec-2017/type-of-claim')
        }
    ...
    app.post('*/prototype-dec-2017/spec-claim-amount-type', function(req, res){
        if (!req.body.interestTotal) {
            res.render('prototype-dec-2017/spec-claim-amount-type')
        }
    ...
    app.post('*/prototype-dec-2017/fixed-claim-amount-total', function(req, res){
    ...
    app.post('*/prototype-dec-2017/choose-how-to-pay', function (req, res) {
        if (!req.body.paymentType) {
            res.render('prototype-dec-2017/choose-how-to-pay')
        }
    ...
    app.post('*/prototype-dec-2017/fixed-claim-amount', function (req, res) {
    ...
    app.post('*/prototype-dec-2017/personal-injury', function (req, res) {
        res.redirect('housing-disrepair')
    });

    app.post('*/prototype-dec-2017/housing-disrepair', function (req, res) {
        res.redirect('claim-details')
    });

    app.post('*/prototype-dec-2017/claim-details', function (req, res) {
    ...
    app.post('*/prototype-dec-2017/claim-amount', function (req, res) {
        res.redirect('claim-total')
    });

    app.get('*/prototype-dec-2017/claim-total', function (req, res) {
        var value = 0;
        ...
        if (req.session.data.typeOfClaim === 'specified') {
            ...
            res.render('prototype-dec-2017/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount), claimType: req.session.data.typeOfClaim, total: formatter.format(value), fee: formatter.format(fee)})
        }
        else {
            res.render('prototype-dec-2017/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount) })
        }
    });

    app.post('*/prototype-dec-2017/claim-total', function (req, res) {
        res.redirect('claim-details-summary')
    })

    app.get('*/prototype-dec-2017/claim-details-summary', function (req, res) {
        var defendants = req.session.defendants || [];
        var claimants = req.session.claimants || [];
        var formatter = new Intl.NumberFormat('en-GB', {
            style: 'currency',
        ...
        res.render('prototype-dec-2017/claim-details-summary', { issueFeeAmount: req.session.data.issueFeeAmount, defendants: defendants, claimants: claimants, value: formatter.format(req.session.data.value), claimType: req.session.data.typeOfClaim })
    })

    app.get('*/prototype-dec-2017/claim-submitted', function (req, res) {
        var moment = require('moment');
        ...
        res.render('prototype-dec-2017/claim-submitted', {today: moment().format('D MMMM YYYY'), dueDate: objDueDate.format('D MMMM YYYY'), confirmDueDate: objConfirmDueDate.format('D MMMM YYYY'), claimType: req.session.data.typeOfClaim, issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount), value: formatter.format(req.session.data.value)  })
    })

    app.get('*/prototype-dec-2017/pay-by-card', function (req, res) {
        res.render('prototype-dec-2017/pay-by-card')
    })

    app.get('*/prototype-dec-2017/pay-by-account', function (req, res) {
        res.render('prototype-dec-2017/pay-by-account')
    })

    app.get('*/prototype-dec-2017/email', function (req, res) {
        var moment = require('moment');
        var issueDate = moment();
        ...
        res.render('prototype-dec-2017/email', {issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount)})
    })


    app.get('*/prototype-dec-2017/logout', function (req, res) {
        req.session.destroy()
        res.redirect('login')
    })

    app.get('*/prototype-dec-2017/certificate', function(req, res){
        ...
        res.render('prototype-dec-2017/certificate/index', { defendant: req.session.defendant })
    });


    app.get('*/prototype-dec-2017/certificate/upload', function(req, res){
        ...
        res.render('prototype-dec-2017/certificate/upload', { defendant: defendant, documents: documents, uploads: req.session.uploads });

    });


    app.post('*/prototype-dec-2017/certificate/upload', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();

        if ( req.body.documents ) {
            req.session.documents = req.body.documents;

            res.render('prototype-dec-2017/certificate/upload', { defendant: defendant, documents: req.session.documents, others: req.body['other-doc'] });
        } else if ( defendant.defendantType == 'company' && defendant.solicitor == '-' ) {
            res.render('prototype-dec-2017/certificate/who', { defendant: defendant })
        } else {
            res.render('prototype-dec-2017/certificate/how', { defendant: defendant })
        }

    });


    app.get('*/prototype-dec-2017/certificate/upload-js', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        req.session.documents = req.body.documents || getDummyDocuments();
        documents = req.session.documents;

        res.render('prototype-dec-2017/certificate/upload-js', { defendant: defendant, documents: documents, uploads: req.session.uploads });

    });


    app.get('*/prototype-dec-2017/certificate/who', function(req, res){
    ...
    app.post('*/prototype-dec-2017/certificate/who', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.get('*/prototype-dec-2017/certificate/how', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();

        res.render('prototype-dec-2017/certificate/how', { defendant: defendant })
    });

    app.post('*/prototype-dec-2017/certificate/how', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        if (req.body['files']) {
    ...
    app.get('*/prototype-dec-2017/certificate/when', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();

        res.render('prototype-dec-2017/certificate/when', { defendant: defendant })
    });

    app.get('*/prototype-dec-2017/certificate/check-your-answers', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
        ...
        res.render('prototype-dec-2017/certificate/check-your-answers', { documents: documents, defendants: defendants, files: files, orgName: orgName })
    });


    app.post('*/prototype-dec-2017/certificate/where', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
        ...
        if ( req.body['how-served']) {
            ...
            req.session.defendants = updateDefendant(defendant, defendants);
            res.render('prototype-dec-2017/certificate/where', { defendant: defendant, howServed: req.body['how-served'] });
        }

    });
    app.get('*/prototype-dec-2017/certificate/where', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.post('*/prototype-dec-2017/certificate/when', function(req, res){
        ...
        if ( req.body['destination'] || typeof req.body['email-address'] !== 'undefined') {
            ...
            res.render('prototype-dec-2017/certificate/when', { defendant: defendant, blnShowTime: blnShowTime, howServed: defendant.howServed });
        } else {
                ...
                for ( i=0; i<defendants.length; i++ ) {
                    if ( defendants[i].defendantNo == defendant.defendantNo ) {
                        ...
                        if ( req.session.defendant.defendantType == 'company' && req.session.defendant.solicitor == '-' ) {
                            res.render('prototype-dec-2017/certificate/who', { defendant: req.session.defendant })
                        } else {
                            res.render('prototype-dec-2017/certificate/how', { defendant: req.session.defendant })
                        }
    ...
    app.post('*/prototype-dec-2017/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-dec-2017/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-dec-2017/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-dec-2017/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-dec-2017/certificate/view', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
        var documents = req.session.documents || getDummyDocuments();
        var files = req.session.files || getDummyFiles();
        var orgName = req.session.orgName || 'My Solicitor Firm';

        res.render('prototype-dec-2017/certificate/view', { documents: documents, defendants: defendants, files: files, orgName: orgName })
    });

    app.get('*/prototype-dec-2017/certificateOfService', function(req, res){
        ...
        res.render('prototype-dec-2017/certificateOfService', { defendant: defendant, claimants: claimants, documents: getDummyDocuments(), signerName: 'Robert Wagner', signerCompany: 'Wagner & Co Legal', signerRole: 'Senior solicitor', signerDate: '14 October 2017', serviceSentDate: serviceSentDate, serviceDate: defendant.serveDate, claimReferenceNumber: '123ML143' });
    });

    app.post('*/prototype-dec-2017/acknowledgement/check-your-answers', function(req, res){

        if ( !req.session.data['intention'] ) {
            req = getResponseData(req);
        }
        res.render('prototype-dec-2017/acknowledgement/check-your-answers', { data: req.session.data } );
    });

    app.get('*/prototype-dec-2017/acknowledgement/check-your-answers', function(req, res){
    ...
    app.get('*/prototype-dec-2017/acknowledgement/view', function(req, res){
        req = getResponseData(req);
        res.render('prototype-dec-2017/acknowledgement/view', { data: req.session.data } );
    });

    app.post('*/prototype-dec-2017/respondent/response', function(req, res){

        if ( !req.body['response'] ) {
            res.render('prototype-dec-2017/respondent/response', { data: req.session.data } );
    ...
    app.post('*/prototype-dec-2017/respondent/check-your-answers', function(req, res){
        ...
        res.render('prototype-dec-2017/respondent/check-your-answers', { data: req.session.data } );
    });


    app.get('*/prototype-dec-2017/respondent/check-your-answers', function(req, res){
    ...
    app.get('*/prototype-dec-2017/respondent/view', function(req, res){
        ...
        res.render('prototype-dec-2017/respondent/view', { data: req.session.data } );
