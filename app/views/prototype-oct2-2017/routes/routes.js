module.exports = function(app){
    ...
    app.post('*/prototype-oct2-2017/representative-address', function(req, res){
        req.session.orgName = req.body['rep_company_name'];

        res.render('prototype-oct2-2017/representative-address');
    });

    app.get('*/prototype-oct2-2017/what-type-of-claimant', function(req, res){
        var claimants = req.session.claimants || [];

        res.render('prototype-oct2-2017/what-type-of-claimant', { claimants: claimants })
    });

    app.post('*/prototype-oct2-2017/what-type-of-claimant', function(req, res){
        var claimants = req.session.claimants || [];
    ...
    app.get('*/prototype-oct2-2017/claimant-address', function(req, res){
        var claimants = req.session.claimants || [];

        res.render('prototype-oct2-2017/claimant-address', { claimants: claimants })
    });


    app.post('*/prototype-oct2-2017/claimant-add', function(req, res){
        ...
        if (req.body.addClaimant === undefined) {
            ...
            res.render('prototype-oct2-2017/claimant-add', { claimants: claimants })
    ...
    app.post('*/prototype-oct2-2017/representation', function(req, res){
    ...
    app.get('*/prototype-oct2-2017/defendants-service-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-oct2-2017/defendants-service-address', { defendants: defendants })
    });

    app.get('*/prototype-oct2-2017/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-oct2-2017/defendant-type', { defendants: defendants })
    });

    app.post('*/prototype-oct2-2017/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.get('*/prototype-oct2-2017/defendant-details', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-oct2-2017/defendant-details', { defendants: defendants })
    });

    app.post('*/prototype-oct2-2017/defendant-represented', function(req, res){
        if (req.body.defendantRepresented === undefined) {
            res.render('prototype-oct2-2017/defendant-represented')
    ...
    app.get('*/prototype-oct2-2017/defendant-reps-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-oct2-2017/defendant-reps-address', { defendants: defendants })
    });

    app.post('*/prototype-oct2-2017/defendant-reps-address', function(req, res){
    ...
    app.post('*/prototype-oct2-2017/defendants-service-address', function(req, res){
    ...
    app.post('*/prototype-oct2-2017/defendants-service-address-other', function(req, res){
    ...
    app.get('*/prototype-oct2-2017/defendant-add', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.post('*/prototype-oct2-2017/defendant-add', function(req, res){
    ...
    app.post('*/prototype-oct2-2017/jurisdiction-statements', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-oct2-2017/jurisdiction-statements-2', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-oct2-2017/type-of-claim', function(req, res){
        if (!req.body.typeOfClaim) {
            res.render('prototype-oct2-2017/type-of-claim')
        }
    ...
    app.post('*/prototype-oct2-2017/spec-claim-amount-type', function(req, res){
        if (!req.body.interestTotal) {
            res.render('prototype-oct2-2017/spec-claim-amount-type')
        }
    ...
    app.post('*/prototype-oct2-2017/fixed-claim-amount-total', function(req, res){
    ...
    app.post('*/prototype-oct2-2017/choose-how-to-pay', function (req, res) {
        if (!req.body.paymentType) {
            res.render('prototype-oct2-2017/choose-how-to-pay')
        }
    ...
    app.post('*/prototype-oct2-2017/fixed-claim-amount', function (req, res) {
    ...
    app.post('*/prototype-oct2-2017/personal-injury', function (req, res) {
        res.redirect('housing-disrepair')
    });

    app.post('*/prototype-oct2-2017/housing-disrepair', function (req, res) {
        res.redirect('claim-details')
    });

    app.post('*/prototype-oct2-2017/claim-details', function (req, res) {
    ...
    app.post('*/prototype-oct2-2017/claim-amount', function (req, res) {
        res.redirect('claim-total')
    });

    app.get('*/prototype-oct2-2017/claim-total', function (req, res) {
        var value = 0;
        ...
        if (req.session.data.typeOfClaim === 'specified') {
            ...
            res.render('prototype-oct2-2017/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount), claimType: req.session.data.typeOfClaim, total: formatter.format(value), fee: formatter.format(fee)})
        }
        else {
            res.render('prototype-oct2-2017/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount) })
        }
    });

    app.post('*/prototype-oct2-2017/claim-total', function (req, res) {
        res.redirect('claim-details-summary')
    })

    app.get('*/prototype-oct2-2017/claim-details-summary', function (req, res) {
        var defendants = req.session.defendants || [];
        var claimants = req.session.claimants || [];
        var formatter = new Intl.NumberFormat('en-GB', {
            style: 'currency',
        ...
        res.render('prototype-oct2-2017/claim-details-summary', { issueFeeAmount: req.session.data.issueFeeAmount, defendants: defendants, claimants: claimants, value: formatter.format(req.session.data.value), claimType: req.session.data.typeOfClaim })
    })

    app.get('*/prototype-oct2-2017/claim-submitted', function (req, res) {
        var moment = require('moment');
        ...
        res.render('prototype-oct2-2017/claim-submitted', {today: moment().format('D MMMM YYYY'), dueDate: objDueDate.format('D MMMM YYYY'), confirmDueDate: objConfirmDueDate.format('D MMMM YYYY'), claimType: req.session.data.typeOfClaim, issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount), value: formatter.format(req.session.data.value)  })
    })

    app.get('*/prototype-oct2-2017/pay-by-card', function (req, res) {
        res.render('prototype-oct2-2017/pay-by-card')
    })

    app.get('*/prototype-oct2-2017/pay-by-account', function (req, res) {
        res.render('prototype-oct2-2017/pay-by-account')
    })

    app.get('*/prototype-oct2-2017/email', function (req, res) {
        var moment = require('moment');
        var issueDate = moment();
        ...
        res.render('prototype-oct2-2017/email', {issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount)})
    })


    app.get('*/prototype-oct2-2017/logout', function (req, res) {
        req.session.destroy()
        res.redirect('login')
    })
    ...
    app.get('*/prototype-oct2-2017/certificate/upload', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
    ...
    app.post('*/prototype-oct2-2017/certificate/how', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        if (req.body['files']) {
    ...
    app.get('*/prototype-oct2-2017/certificate/when', function(req, res){
        ...
        res.render('prototype-oct2-2017/certificate/when', { defendant: defendant })
    });

    app.get('*/prototype-oct2-2017/certificate/check-your-answers', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.post('*/prototype-oct2-2017/certificate/where', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.post('*/prototype-oct2-2017/certificate/when', function(req, res){
        ...
        if ( req.body['destination'] || typeof req.body['email-address'] !== 'undefined') {
            ...
            res.render('prototype-oct2-2017/certificate/when', { defendant: defendant, blnShowTime: blnShowTime, howServed: defendant.howServed });
        } else {
    ...
    app.post('*/prototype-oct2-2017/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-oct2-2017/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-oct2-2017/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
...
//        var defendant = { defendantNo: 2, defendantTitle: 'Mr', defendantName: 'Bob Goddard', defendantFirstName: 'Bob', defendantCompanyNumber: '-', address: { line1: '31 Old Farm Road', line2: '', city: 'Guildford', postcode: 'GU3 3QP'}, solicitor: 'Keoghs', serviceAddress: '2 COLCHESTER STREET\n COVENTRY\n CV1 5NZ', defendantCountry: 'England', howServed: 'First class post or other next-day service', serviceMethod: 'post', serviceFax: '01483 562742', destination: 'place of business', serveDay: '8', serveMonth: '10', serveMonthWord: 'Oct', serveYear: '2017', serveDate: '9 October 2017', serveHour: '6', serveMinutes: '23', serveAmPm: 'PM' };
        ...
        res.render('prototype-oct2-2017/certificateOfService', { defendant: defendant, claimants: claimants, documents: getDummyDocuments(), signerName: 'Robert Wagner', signerCompany: 'Wagner & Co Legal', signerRole: 'Senior solicitor', signerDate: '14 October 2017', serviceSentDate: serviceSentDate, serviceDate: defendant.serveDate, claimReferenceNumber: '123ML143' });
    });
...
function getDummyDefendants() {
    return [ { defendantNo: 1, defendantName: 'Jan Clarke', defendantFirstName: 'Jan', defendantCompanyNumber: '-', defendantAddress: '115 EASTWICK PARK AVENUE LEATHERHEAD KT23 3NW', solicitor: '-', serviceAddress: '115 EASTWICK PARK AVENUE\nLEATHERHEAD\nKT23 3NW', defendantCountry: 'England', howServed: 'First class post or other next-day service', destination: 'usual residence', serveDay: '11', serveMonth: '10', serveMonthWord: 'Oct', serveYear: '2017', serveDate: '13 Oct 2017' }, { defendantNo: 2, defendantName: 'Bob Goddard', defendantFirstName: 'Bob', defendantCompanyNumber: '-', defendantAddress: '30 LONGBRIDGE ROAD\n HORLEY\n RH6 7EL', solicitor: 'Keoghs', serviceAddress: '2 COLCHESTER STREET\n COVENTRY\n CV1 5NZ', defendantCountry: 'England', howServed: 'Fax', serviceFax: '01483 562742', destination: 'place of business', serveDay: '8', serveMonth: '10', serveMonthWord: 'Oct', serveYear: '2017', serveDate: '9 Oct 2017', serveHour: '6', serveMinutes: '23', amPm: 'PM' }, { defendantNo: 3, defendantName: 'Chris Kingsley', defendantFirstName: 'Chris', defendantCompanyNumber: '-', defendantAddress: '31 TANGLEY LANE GUILDFORD GU3 3JU', solicitor: '-', serviceAddress: '31 TANGLEY LANE\n GUILDFORD\n GU3 3JU', defendantCountry: 'England', howServed: 'Personally handed to or left with with recipient', leftWith: 'Dave Smith', destination: 'principal place of business', serveDay: '9', serveMonth: '10', serveMonthWord: 'Oct', serveYear: '2017', serveDate: '9 Oct 2017' } ];
}
