module.exports = function(app){
    ...
    app.post('*/prototype-jan-2018/representative-address', function(req, res){
        req.session.orgName = req.body['rep_company_name'];

        res.render('prototype-jan-2018/representative-address');
    });

    app.get('*/prototype-jan-2018/claimant-name', function(req, res){
        var claimants = req.session.claimants || [];

        res.render('prototype-jan-2018/claimant-name', { claimants: claimants })
    });

    app.post('*/prototype-jan-2018/claimant-name', function(req, res){
        var claimants = req.session.claimants || [];
    ...
    app.get('*/prototype-jan-2018/defendants-service-address', function(req, res){
        ...
        res.render('prototype-jan-2018/defendants-service-address', { defendants: defendants })
    });

    app.get('*/prototype-jan-2018/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-jan-2018/defendant-type', { defendants: defendants })
    });

    app.post('*/prototype-jan-2018/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.get('*/prototype-jan-2018/defendant-details', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.get('*/prototype-jan-2018/defendant-reps-address', function(req, res){
        ...
        res.render('prototype-jan-2018/defendant-reps-address', { defendants: defendants })
    });
    ...
    app.get('*/prototype-jan-2018/defendant-add', function(req, res){
        ...
        res.render('prototype-jan-2018/defendant-add', { defendants: defendants })
    });


    app.post('*/prototype-jan-2018/defendant-add', function(req, res){
    ...
    app.post('*/prototype-jan-2018/jurisdiction-statements', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-jan-2018/jurisdiction-statements-2', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-jan-2018/type-of-claim', function(req, res){
        if (!req.body.typeOfClaim) {
            res.render('prototype-jan-2018/type-of-claim')
        }
    ...
    app.post('*/prototype-jan-2018/fixed-claim-amount-total', function(req, res){
    ...
    app.post('*/prototype-jan-2018/choose-how-to-pay', function (req, res) {
        if (!req.body.paymentType) {
            res.render('prototype-jan-2018/choose-how-to-pay')
        }
    ...
    app.post('*/prototype-jan-2018/fixed-claim-amount', function (req, res) {
    ...
    app.post('*/prototype-jan-2018/personal-injury', function (req, res) {
        res.redirect('housing-disrepair')
    });

    app.post('*/prototype-jan-2018/housing-disrepair', function (req, res) {
        res.redirect('claim-details')
    });

    app.post('*/prototype-jan-2018/claim-details', function (req, res) {
    ...
    app.post('*/prototype-jan-2018/claim-amount', function (req, res) {
        res.redirect('claim-total')
    });

    app.get('*/prototype-jan-2018/claim-total', function (req, res) {
        var value = 0;
        ...
        if (req.session.data.typeOfClaim === 'specified') {
            ...
            res.render('prototype-jan-2018/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount), claimType: req.session.data.typeOfClaim, total: formatter.format(value), fee: formatter.format(fee)})
        }
        else {
            res.render('prototype-jan-2018/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount) })
        }
    });

    app.post('*/prototype-jan-2018/claim-total', function (req, res) {
        res.redirect('claim-details-summary')
    })

    app.get('*/prototype-jan-2018/claim-details-summary', function (req, res) {
        var defendants = req.session.defendants || [];
        var claimants = req.session.claimants || [];
        var formatter = new Intl.NumberFormat('en-GB', {
            style: 'currency',
        ...
        res.render('prototype-jan-2018/claim-details-summary', { issueFeeAmount: req.session.data.issueFeeAmount, defendants: defendants, claimants: claimants, value: formatter.format(req.session.data.value), claimType: req.session.data.typeOfClaim })
    })

    app.get('*/prototype-jan-2018/claim-submitted', function (req, res) {
        var moment = require('moment');
    ...
    app.get('*/prototype-jan-2018/pay-by-card', function (req, res) {
        res.render('prototype-jan-2018/pay-by-card')
    })

    app.get('*/prototype-jan-2018/pay-by-account', function (req, res) {
        res.render('prototype-jan-2018/pay-by-account')
    })

    app.get('*/prototype-jan-2018/email', function (req, res) {
        var moment = require('moment');
        var issueDate = moment();
        ...
        res.render('prototype-jan-2018/email', {issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount)})
    })


    app.get('*/prototype-jan-2018/logout', function (req, res) {
        req.session.destroy()
        res.redirect('login')
    })

    app.get('*/prototype-jan-2018/certificate', function(req, res){
        ...
        res.render('prototype-jan-2018/certificate/index', { defendant: req.session.defendant })
    });


    app.get('*/prototype-jan-2018/certificate/upload', function(req, res){
        ...
        res.render('prototype-jan-2018/certificate/upload', { defendant: defendant, documents: documents, uploads: req.session.uploads });

    });


    app.post('*/prototype-jan-2018/certificate/upload', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
    ...
    app.get('*/prototype-jan-2018/certificate/upload-js', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        req.session.documents = req.body.documents || getDummyDocuments();
        documents = req.session.documents;

        res.render('prototype-jan-2018/certificate/upload-js', { defendant: defendant, documents: documents, uploads: req.session.uploads });

    });


    app.get('*/prototype-jan-2018/certificate/who', function(req, res){
    ...
    app.post('*/prototype-jan-2018/certificate/who', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.post('*/prototype-jan-2018/certificate/how', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        if (req.body['files']) {
    ...
    app.get('*/prototype-jan-2018/certificate/when', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();

        res.render('prototype-jan-2018/certificate/when', { defendant: defendant })
    });

    app.get('*/prototype-jan-2018/certificate/check-your-answers', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.post('*/prototype-jan-2018/certificate/when', function(req, res){
        ...
        if ( req.body['destination'] || typeof req.body['email-address'] !== 'undefined') {
            ...
            res.render('prototype-jan-2018/certificate/when', { defendant: defendant, blnShowTime: blnShowTime, howServed: defendant.howServed });
        } else {
                ...
                for ( i=0; i<defendants.length; i++ ) {
                    if ( defendants[i].defendantNo == defendant.defendantNo ) {
                        ...
                        if ( req.session.defendant.defendantType == 'company' && req.session.defendant.solicitor == '-' ) {
                            res.render('prototype-jan-2018/certificate/who', { defendant: req.session.defendant })
                        } else {
                            res.render('prototype-jan-2018/certificate/how', { defendant: req.session.defendant })
                        }
    ...
    app.post('*/prototype-jan-2018/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-jan-2018/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-jan-2018/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-jan-2018/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-jan-2018/certificate/view', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
        var documents = req.session.documents || getDummyDocuments();
        var files = req.session.files || getDummyFiles();
        var orgName = req.session.orgName || 'My Solicitor Firm';

        res.render('prototype-jan-2018/certificate/view', { documents: documents, defendants: defendants, files: files, orgName: orgName })
    });

    app.get('*/prototype-jan-2018/certificateOfService', function(req, res){
        ...
        res.render('prototype-jan-2018/certificateOfService', { defendant: defendant, claimants: claimants, documents: getDummyDocuments(), signerName: 'Robert Wagner', signerCompany: 'Wagner & Co Legal', signerRole: 'Senior solicitor', signerDate: '14 October 2017', serviceSentDate: serviceSentDate, serviceDate: defendant.serveDate, claimReferenceNumber: '123ML143' });
    });

    app.post('*/prototype-jan-2018/acknowledgement/check-your-answers', function(req, res){

        if ( !req.session.data['intention'] ) {
            req = getResponseData(req);
        }
        res.render('prototype-jan-2018/acknowledgement/check-your-answers', { data: req.session.data } );
    });

    app.get('*/prototype-jan-2018/acknowledgement/check-your-answers', function(req, res){
    ...
    app.get('*/prototype-jan-2018/acknowledgement/view', function(req, res){
        req = getResponseData(req);
...
//        req.session.data['response'] = 'Admission';
    ...
    app.post('*/prototype-jan-2018/judgment/transfer', function(req, res){
    ...
    app.post('*/prototype-jan-2018/extension/respond', function(req, res){
