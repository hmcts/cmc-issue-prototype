module.exports = function(app){
    ...
    app.post('*/prototype-mar-2018/representative-address', function(req, res){
        req.session.orgName = req.body['rep_company_name'];

        res.render('prototype-mar-2018/representative-address');
    });

    app.get('*/prototype-mar-2018/claimant-name', function(req, res){
        var claimants = req.session.claimants || [];

        res.render('prototype-mar-2018/claimant-name', { claimants: claimants })
    });

    app.post('*/prototype-mar-2018/claimant-name', function(req, res){
        var claimants = req.session.claimants || [];
    ...
    app.get('*/prototype-mar-2018/claimant-address', function(req, res){
        var claimants = req.session.claimants || [];
        res.render('prototype-mar-2018/claimant-address', { claimants: claimants })
    });

    app.post('*/prototype-mar-2018/claimant-suitability', function(req, res){
        var claimants = req.session.claimants || [];
        ...
        if ( req.body['claimant_protected'] ) {
            ...
            res.render('prototype-mar-2018/claimant-suitability', { claimants: claimants })
        }

    });

    app.post('*/prototype-mar-2018/litigation-friend-address-same', function(req, res){
        var claimants = req.session.claimants || [];
        ...
        if ( req.body['friend_address_same'] ) {
            ...
            res.render('prototype-mar-2018/litigation-friend-address-same', { claimants: claimants })
        }

    });


    app.get('*/prototype-mar-2018/claimant-add', function(req, res){
        checkClaimantAdd( req, res );
    });

    app.post('*/prototype-mar-2018/claimant-add', function(req, res){
        checkClaimantAdd( req, res );
    });
    ...
    function checkClaimantAdd( req, res ) {
        ...
        if (req.body.addClaimant === undefined) {
            ...
            res.render('prototype-mar-2018/claimant-add', { claimants: claimants })
    ...
    app.post('*/prototype-mar-2018/representation', function(req, res){
    ...
    app.get('*/prototype-mar-2018/defendants-service-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-mar-2018/defendants-service-address', { defendants: defendants })
    });

    app.get('*/prototype-mar-2018/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-mar-2018/defendant-type', { defendants: defendants })
    });

    app.post('*/prototype-mar-2018/defendant-type', function(req, res){
        var defendants = req.session.defendants || [];
    ...
    app.get('*/prototype-mar-2018/defendant-details', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-mar-2018/defendant-details', { defendants: defendants })
    });

    app.get('*/prototype-mar-2018/defendant-reps-address', function(req, res){
        var defendants = req.session.defendants || [];

        res.render('prototype-mar-2018/defendant-reps-address', { defendants: defendants })
    });


    app.post('*/prototype-mar-2018/defendant-reps-email', function(req, res){
    ...
    app.post('*/prototype-mar-2018/confirm-rep', function(req, res){
    ...
    app.post('*/prototype-mar-2018/defendant-reps-email-service', function(req, res){
        res.redirect('defendant-add');
    });



    app.post('*/prototype-mar-2018/defendant-reps-address', function(req, res){
    ...
    app.post('*/prototype-mar-2018/jurisdiction-proceedings', function(req, res){

        if ( req.session.data['proceedings'] == 'no' ) {
            res.render('prototype-mar-2018/jurisdiction-domiciled', { strCountry: req.session.defendantCountry } );
    ...
    app.post('*/prototype-mar-2018/jurisdiction-domiciled', function(req, res){
        ...
        if ( req.session.data['domiciled'] == 'yes' && isUK( req.session.defendantCountry ) ) {
            res.render('prototype-mar-2018/jurisdiction-statements-1a', { strCountry: req.session.defendantCountry } );
        } else if ( req.session.data['domiciled'] == 'no' && isUK( req.session.defendantCountry ) ) {
           res.render('prototype-mar-2018/jurisdiction-statements', { strCountry: req.session.defendantCountry } );
        } else if ( req.session.data['domiciled'] == 'yes' && isConventionTerritory( req.session.defendantCountry ) ) {
            res.render('prototype-mar-2018/jurisdiction-statements-2a', { strCountry: req.session.defendantCountry } );
        } else if ( req.session.data['domiciled'] == 'no' && isConventionTerritory( req.session.defendantCountry ) ) {
            res.render('prototype-mar-2018/jurisdiction-statements-2', { strCountry: req.session.defendantCountry } );
        }

    });


    app.post('*/prototype-mar-2018/defendants-service-address', function(req, res){
    ...
    app.post('*/prototype-mar-2018/defendants-service-address-other', function(req, res){
    ...
    app.get('*/prototype-mar-2018/defendant-add', function(req, res){
        ...
        res.render('prototype-mar-2018/defendant-add', { defendants: defendants })
    });


    app.post('*/prototype-mar-2018/defendant-add', function(req, res){
    ...
    app.post('*/prototype-mar-2018/jurisdiction-statements', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-mar-2018/jurisdiction-statements-2', function(req, res){
        res.redirect('defendant-add');
    });

    app.post('*/prototype-mar-2018/type-of-claim', function(req, res){
        if (!req.body.typeOfClaim) {
            res.render('prototype-mar-2018/type-of-claim')
        }
    ...
    app.post('*/prototype-mar-2018/spec-claim-amount-type', function(req, res){
        if (!req.body.interestTotal) {
            res.render('prototype-mar-2018/spec-claim-amount-type')
        }
    ...
    app.post('*/prototype-mar-2018/fixed-claim-amount-total', function(req, res){
    ...
    app.post('*/prototype-mar-2018/help-with-fees', function (req, res) {

        if (req.body.helpFees == 'yes') {
            res.render('prototype-mar-2018/pay-by-account', { blnHelpFees: true });
        } else if (req.body.helpFees == 'no') {
            res.render('prototype-mar-2018/pay-by-account');
        } else {
            res.render('prototype-mar-2018/help-with-fees')
        }

    });

    app.post('*/prototype-mar-2018/choose-how-to-pay', function (req, res) {
        if (!req.body.paymentType) {
            res.render('prototype-mar-2018/choose-how-to-pay')
        }
    ...
    app.post('*/prototype-mar-2018/defendant-represented', function(req, res){
        if (req.body.defendantRepresented === undefined) {
            res.render('prototype-mar-2018/defendant-represented')
    ...
    app.get('*/prototype-mar-2018/defendant-rep-search', function (req, res) {
        req.session.data['service'] = 'digital';
        res.render('prototype-mar-2018/defendant-rep-search');
    });

    app.post('*/prototype-mar-2018/defendant-rep-search', function (req, res) {
    ...
    app.post('*/prototype-mar-2018/fixed-claim-amount', function (req, res) {
    ...
    app.post('*/prototype-mar-2018/personal-injury', function (req, res) {
        res.redirect('housing-disrepair')
    });

    app.post('*/prototype-mar-2018/housing-disrepair', function (req, res) {
        res.redirect('claim-details')
    });

    app.post('*/prototype-mar-2018/claim-details', function (req, res) {
    ...
    app.post('*/prototype-mar-2018/claim-amount', function (req, res) {
        res.redirect('claim-total')
    });

    app.get('*/prototype-mar-2018/claim-total', function (req, res) {
        var value = 0;
        ...
        if (req.session.data.typeOfClaim === 'specified') {
            ...
            res.render('prototype-mar-2018/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount), claimType: req.session.data.typeOfClaim, total: formatter.format(value), fee: formatter.format(fee)})
        }
        else {
            res.render('prototype-mar-2018/claim-total', { issueFeeAmount: formatter.format(issueFeeAmount) })
        }
    });

    app.post('*/prototype-mar-2018/claim-total', function (req, res) {
        res.redirect('help-with-fees')
    })

    app.get('*/prototype-mar-2018/claim-details-summary', function (req, res) {
        ...
        res.render('prototype-mar-2018/claim-details-summary', { issueFeeAmount: req.session.data.issueFeeAmount, defendants: defendants, claimants: claimants, value: formatter.format(req.session.data.value), claimType: req.session.data.typeOfClaim, jursidiction: jursidiction })
    })

    app.get('*/prototype-mar-2018/claim-submitted', function (req, res) {
        var moment = require('moment');
    ...
    app.get('*/prototype-mar-2018/email', function (req, res) {
        ...
        res.render('prototype-mar-2018/email', {issueDate: moment(issueDate).format('D MMMM YYYY'), issueFeeAmount: formatter.format(req.session.data.issueFeeAmount)})
    })


    app.get('*/prototype-mar-2018/logout', function (req, res) {
        req.session.destroy()
        res.redirect('login')
    })

    app.get('*/prototype-mar-2018/certificate', function(req, res){
        ...
        res.render('prototype-mar-2018/certificate/index', { defendant: req.session.defendant })
    });


    app.get('*/prototype-mar-2018/certificate/upload', function(req, res){
        ...
        res.render('prototype-mar-2018/certificate/upload', { defendant: defendant, defendants: defendants, documents: documents, uploads: req.session.uploads });

    });


    app.post('*/prototype-mar-2018/certificate/upload', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
        ...
        if ( req.body.documents ) {
            ...
            res.render('prototype-mar-2018/certificate/upload', { defendant: defendant, defendants: defendants, documents: req.session.documents, others: req.body['other-doc'] });
        } else if ( defendant.defendantType == 'company' && defendant.solicitor == '-' ) {
            res.render('prototype-mar-2018/certificate/who', { defendant: defendant })
        } else if ( defendant.defendantType == 'friend' ) {
            res.render('prototype-mar-2018/certificate/litigation-friend-name', { defendant: defendant })
        } else {
            res.render('prototype-mar-2018/certificate/how', { defendant: defendant })
        }
    ...
    app.get('*/prototype-mar-2018/certificate/who', function(req, res){
    ...
    app.post('*/prototype-mar-2018/certificate/who', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.get('*/prototype-mar-2018/certificate/litigation-friend', function(req, res){
        res.render('prototype-mar-2018/certificate/litigation-friend', { defendant: req.session.defendant })
    });

    app.post('*/prototype-mar-2018/certificate/litigation-friend', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
        ...
        if ( req.body['served-friend'] == 'no' ) {
            ...
            res.render('prototype-mar-2018/certificate/friend-address', { defendant: defendant })
        } else if ( req.body['friend_Postcode'] ) {

            req.session.documents = 'Certificate of suitability';
            res.render('prototype-mar-2018/certificate/upload', { defendant: defendant, defendants: req.session.defendants, documents: req.session.documents, uploads: req.session.uploads });

        } else if ( req.body['served-friend'] == 'yes' ) {
            res.render('prototype-mar-2018/certificate/where', { defendant: defendant })

        } else {

            res.render('prototype-mar-2018/certificate/litigation-friend', { defendant: defendant })
        }


    });

    app.get('*/prototype-mar-2018/certificate/litigation-friend-name', function(req, res){
    ...
    app.get('*/prototype-mar-2018/certificate/how', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();

        res.render('prototype-mar-2018/certificate/how', { defendant: defendant })
    });

    app.post('*/prototype-mar-2018/certificate/how', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        if (req.body['files']) {
    ...
    app.get('*/prototype-mar-2018/certificate/when', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();

        res.render('prototype-mar-2018/certificate/when', { defendant: defendant })
    });

    app.get('*/prototype-mar-2018/certificate/check-your-answers', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
        ...
        res.render('prototype-mar-2018/certificate/check-your-answers', { documents: documents, defendant: defendant, defendants: defendants, files: files, orgName: orgName })
    });

    app.post('*/prototype-mar-2018/certificate/friend-address', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
    ...
    app.post('*/prototype-mar-2018/certificate/where', function(req, res){
        var defendant = req.session.defendant || getDummyDefendant();
        var defendants = req.session.defendants || getDummyDefendants();
        ...
        if ( defendant.howServed && defendant.defendantType == 'authority' ) {
            ...
            res.render('prototype-mar-2018/certificate/where', { defendant: defendant, howServed: defendant.howServed });
        }

    });

    app.get('*/prototype-mar-2018/certificate/where', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
        var defendant = req.session.defendant || defendants[0];

        res.render('prototype-mar-2018/certificate/where', { defendant: defendant, howServed: req.body['how-served'] });

    });

    app.post('*/prototype-mar-2018/certificate/when', function(req, res){
        ...
        if ( req.body['destination'] || typeof req.body['email-address'] !== 'undefined') {
            ...
            res.render('prototype-mar-2018/certificate/when', { defendant: defendant, blnShowTime: blnShowTime, howServed: defendant.howServed });
        } else {
                ...
                for ( i=0; i<defendants.length; i++ ) {
                    if ( defendants[i].defendantNo == defendant.defendantNo ) {
                        ...
                        if ( req.session.defendant.defendantType == 'company' && req.session.defendant.solicitor == '-' ) {
                            res.render('prototype-mar-2018/certificate/who', { defendant: req.session.defendant })
                        } else if ( req.session.defendant.defendantType == 'friend') {
                            res.render('prototype-mar-2018/certificate/litigation-friend', { defendant: req.session.defendant })
                        } else {
                            res.render('prototype-mar-2018/certificate/how', { defendant: req.session.defendant })
                        }
    ...
    app.post('*/prototype-mar-2018/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-mar-2018/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-mar-2018/certificate/submitted', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();

        res.render('prototype-mar-2018/certificate/submitted', { defendants: defendants })
    });

    app.get('*/prototype-mar-2018/certificate/view', function(req, res){
        var defendants = req.session.defendants || getDummyDefendants();
        var documents = req.session.documents || getDummyDocuments();
        var files = req.session.files || getDummyFiles();
        var orgName = req.session.orgName || 'My Solicitor Firm';

        res.render('prototype-mar-2018/certificate/view', { documents: documents, defendants: defendants, files: files, orgName: orgName })
    });

    app.get('*/prototype-mar-2018/certificateOfService', function(req, res){
        ...
        res.render('prototype-mar-2018/certificateOfService', { defendant: defendant, claimants: claimants, documents: getDummyDocuments(), signerName: 'Robert Wagner', signerCompany: 'Wagner & Co Legal', signerRole: 'Senior solicitor', signerDate: '14 October 2017', serviceSentDate: serviceSentDate, serviceDate: defendant.serveDate, claimReferenceNumber: '123ML143' });
    });



    app.post('*/prototype-mar-2018/respondent/dob', function(req, res){

        if ( req.body['year'] == '' ) {
                
            if ( req.session.data['response'] == 'Admission' ) {
                res.render('prototype-mar-2018/respondent/admission', { data: req.session.data } );            
            } else {
                res.render('prototype-mar-2018/respondent/upload', { data: req.session.data } );
            }
    ...
    app.post('*/prototype-mar-2018/respondent/protected', function(req, res){
    ...
    app.get('*/prototype-mar-2018/respondent/litigation-friend-address', function(req, res){
        res.render('prototype-mar-2018/respondent/litigation-friend-address', { defendant: req.session.defendant })
    });

    app.post('*/prototype-mar-2018/respondent/litigation-friend-address', function(req, res){
    ...
    app.get('*/prototype-mar-2018/respondent/litigation-friend-address-same', function(req, res){
        var defs = getDummyDefendants();
        var defendant = defs[0];
        req.session.defendants = [defendant];
        defendant.defendantName = 'Jan Clarke';
        req.session.defendant = defendant;
        res.render('prototype-mar-2018/respondent/litigation-friend-address-same', { defendant: defendant })
    });

    app.post('*/prototype-mar-2018/respondent/litigation-friend-address-same', function(req, res){
        var claimants = req.session.claimants || [];
        ...
        if ( req.body['friend_address_same'] ) {
            ...
            res.render('prototype-mar-2018/respondent/litigation-friend-address-same', { claimants: claimants })
        }
...
/*
    ...
    app.post('*XXX/prototype-mar-2018/respondent/litigation-friend-address-same', function(req, res){
...
*/
    ...
    app.post('*/prototype-mar-2018/respondent/litigation-friend-name', function(req, res){
        var defs = getDummyDefendants();
        var defendant = defs[0];
        req.session.defendants = [defendant];
        defendant.defendantName = 'Jan Clarke';
        req.session.defendant = defendant;
        res.render('prototype-mar-2018/respondent/litigation-friend-name', { defendant: defendant })
    });

    app.get('*/prototype-mar-2018/respondent/litigation-friend-name', function(req, res){
        var defs = getDummyDefendants();
        var defendant = defs[0];
        req.session.defendants = [defendant];
        defendant.defendantName = 'Jan Clarke';
    ...
    app.get('*/prototype-mar-2018/acknowledgement/name', function(req, res){
        req.session.data['name'] = 'Jan Clarke';
        res.render('prototype-mar-2018/acknowledgement/name' );

    });

    app.post('*/prototype-mar-2018/acknowledgement/name', function(req, res){
    ...
    app.get('*/prototype-mar-2018/acknowledgement/representative-name', function(req, res){
        req.session.data['name'] = 'Jan Clarke';
        res.render('prototype-mar-2018/acknowledgement/representative-name' );

    });

    app.post('*/prototype-mar-2018/acknowledgement/dob', function(req, res){

        if ( req.body['year'] == '' ) {
            res.render('prototype-mar-2018/acknowledgement/intention' );
        } else {
    ...
    app.post('*/prototype-mar-2018/acknowledgement/protected', function(req, res){
    ...
    app.post('*/prototype-mar-2018/acknowledgement/litigation-friend-address-same', function(req, res){
        var claimants = req.session.claimants || [];
        ...
        if ( req.body['friend_address_same'] ) {
            ...
            res.render('prototype-mar-2018/acknowledgement/litigation-friend-address-same', { claimants: claimants })
        }
    ...
    app.post('*/prototype-mar-2018/acknowledgement/check-your-answers', function(req, res){
        ...
        res.render('prototype-mar-2018/acknowledgement/check-your-answers', { data: req.session.data } );
    });

    app.get('*/prototype-mar-2018/acknowledgement/check-your-answers', function(req, res){
    ...
    app.get('*/prototype-mar-2018/acknowledgement/view', function(req, res){
        req = getResponseData(req);
        res.render('prototype-mar-2018/acknowledgement/view', { data: req.session.data } );
    });

    app.get('*/prototype-mar-2018/respondent/start-defence', function(req, res){
        req.session.data['response'] = 'Defence';
        res.render('prototype-mar-2018/respondent/your-reference', { data: req.session.data } );
    });

    app.get('*/prototype-mar-2018/respondent/start-admission', function(req, res){
        req.session.data['response'] = 'Admission';
        res.render('prototype-mar-2018/respondent/your-reference', { data: req.session.data } );
    });

    app.post('*/prototype-mar-2018/respondent/name', function(req, res){
        if ( req.body['correct-name'] ) {
    ...
    app.post('*/prototype-mar-2018/respondent/upload-admission', function(req, res){
//        req.session.data['response'] = 'Admission';
        res.redirect('upload');
    ...
    app.post('*/prototype-mar-2018/respondent/check-your-answers', function(req, res){
        ...
        res.render('prototype-mar-2018/respondent/check-your-answers', { data: req.session.data } );
    });


    app.get('*/prototype-mar-2018/respondent/check-your-answers', function(req, res){   
    ...
    app.get('*/prototype-mar-2018/respondent/view', function(req, res){
        ...
        res.render('prototype-mar-2018/respondent/view', { data: req.session.data } );

    });

    app.post('*/prototype-mar-2018/judgment/transfer', function(req, res){
    ...
    app.post('*/prototype-mar-2018/extension/agreed', function(req, res){
        ...
        if ( req.body['agreed'] === 'yes' ) {
            ...
            res.render('prototype-mar-2018/extension/agreed', { data: req.session.data } );
        }
    });

    app.post('*/prototype-mar-2018/extension/respond', function(req, res){
    ...
    app.post('*/prototype-mar-2018/extension/counter-extend', function(req, res){
    ...
    app.post('*/prototype-mar-2018/extension/response', function(req, res){
...
//  old version with certificate of suitability service in
